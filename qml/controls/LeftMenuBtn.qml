...
Button{
    ...
    property color activateMenuColor: "#55aaff"
    property color activateMenuColorRight: "#2c313c"
    property bool isActivateMenu: false
    ...
    background: Rectangle{
        ...
        Rectangle{
            ...
            color: activateMenuColor
            width: 3
            visible: isActivateMenu
        }
